 ...
 */
require_once 'models/validator/HTTP/Request2.php';

/**
 * Uses response object.
 */
require_once 'models/validator/Services/W3C/HTMLValidator/Response.php';

require_once 'models/validator/Services/W3C/HTMLValidator/Error.php';

require_once 'models/validator/Services/W3C/HTMLValidator/Warning.php';
