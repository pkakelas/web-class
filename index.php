...
?>
        ...
        <div id="everything">
            ...
            <div id="register">
                <h2>Εγγραφή</h2>
                <p>
                    Οι εγγραφές συμμετεχόντων θα ξεκινήσουν από την 5η Οκτωβρίου 2010.
                </p>
            </div>
            ...
            <div id="projects">
                <h2>Projects</h2>
                <p>
                    Κατά τη διάρκεια του εξαμήνου, οι συμμετέχοντες θα αναλάβουν την πραγματοποίηση αρκετών μικρών εργασιών
                    και ενός μεγάλου τελικού project. Οι λεπτομέρειες θα ανακοινωθούν μετά τις αντίστοιχες διαλέξεις.
                </p>
            </div>
            -->
        </div>
